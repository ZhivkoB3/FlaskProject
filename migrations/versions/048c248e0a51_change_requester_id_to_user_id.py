"""change requester_id to user_id

Revision ID: 048c248e0a51
Revises: 1dd9738b04a3
Create Date: 2022-01-08 22:22:00.097072
...
revision = '048c248e0a51'
down_revision = '1dd9738b04a3'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('payment_requests', sa.Column('user_id', sa.Integer(), nullable=True))
    op.drop_constraint('payment_requests_requester_id_fkey', 'payment_requests', type_='foreignkey')
    op.create_foreign_key(None, 'payment_requests', 'payment_receivers', ['user_id'], ['pk'])
    op.drop_column('payment_requests', 'requester_id')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('payment_requests', sa.Column('requester_id', sa.INTEGER(), autoincrement=False, nullable=True))
    op.drop_constraint(None, 'payment_requests', type_='foreignkey')
    op.create_foreign_key('payment_requests_requester_id_fkey', 'payment_requests', 'payment_receivers', ['requester_id'], ['pk'])
