...
class TestPutWaterDataEntry(BaseTestCase):
    """
    ...
    def test_put_to_water(self):
        ...
        water_data_modified = WaterModel.query.all()
        assert len(water_data_modified) == 1
...
class TestPutGasDataEntry(BaseTestCase):
    """
    ...
    def test_put_to_gas(self):
        ...
        gas_data_modified = NaturalGasModel.query.all()
        assert len(gas_data_modified) == 1
...
class TestPutElectricityDataEntry(BaseTestCase):
    """
    ...
    def test_put_to_electricity(self):
        ...
        electricity_data_modified = ElectricityModel.query.all()
        assert len(electricity_data_modified) == 1
...
class TestPostCompressorsDataEntry(BaseTestCase):
    ...
    def test_put_to_compressors(self):
        ...
        compressors_data_modified = CompressorsModel.query.all()
        assert len(compressors_data_modified) == 1
...
class TestPutWaterDataAnalyst(BaseTestCase):
    """
    Test put requests for "water" database.
    Steps:
    1. Check if there are any records in DB
...
class TestPutGasDataAnalyst(BaseTestCase):
    """
    Test put requests for "gas" database.
    Steps:
    1. Check if there are any records in DB
...
class TestPutElectricityDataAnalyst(BaseTestCase):
    """
    Test put requests for "electicity" database.
    Steps:
    1. Check if there are any records in DB
    2. Write into database
    3. Check if the record is uploaded to the DB
